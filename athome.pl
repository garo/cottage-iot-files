...
CmdWriteTemp(hex('81'), hex('03'), hex('21'), 218); # original: 218

CmdWriteTemp(hex('81'), hex('03'), hex('00'), 55); # original: 55, temp curve

CmdWriteTemp(hex('81'), hex('03'), hex('01'), 1); # original: 1, temp fine adjust
